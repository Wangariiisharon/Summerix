...
export default function AdminInformation() {
  ...
  const doAdmin = async (formValues: {
    firstname: string;
    lastname: string;
    email: string;
    phonenumber: string;
            ...
            <Form className="">
              ...
              <div className="m-4 px-4 grid gap-5 shadow-sm">
                ...
                <div className="flex items-center">
                  <label className="form-label font-mulish text-xs font-semibold">
                    Show Password
                  </label>
                  <span
              ...
              <div className=" px-4 flex flex-row">
                <input
                  className="ml-5"
                  type="checkbox"
                  checked={isCheckboxChecked} // Bind checkbox value to state
              ...
              <div className="my-5 flex justify-center">
                <button
                  type="submit"
                  className="btn btn-primary w-72 mr-7 px-5"
