...
const DriverDetailsPage: React.FC = () => {
  ...
  const [driverDetails, setDriverDetails] = useState<
    DriverDetailsProps["driver"] | null
  >(null);
      ...
      if (id) {
        try {
          ...
          if (driverDocSnap.exists()) {
            const driverData =
              driverDocSnap.data() as DriverDetailsProps["driver"];
  ...
  return (
    <SiteLayout>
      ...
      <div className="ml-10 flex flex-col">
        <div
          className=" rounded-md bg-white flex items-center
          ...
          <div className="p-4 flex flex-row">
            ...
            <div className="ml-2">
              ...
              <p className="p-2 text-gray-700 text-sm">
                Email Address: {driverDetails.email_adress}
              </p>
              <p className="p-2 text-gray-700 text-sm">
                ...
                <div className="flex flex-row bg-[#FAFAFB]">
                  <div className="p-4">
                    <span className="fa-stack fa-lg">
                      <i
                        className="fa fa-stop fa-3x fa-stack-2x text-white"
                        aria-hidden="true"
                      ></i>
                      <i
                        className="fa fa-truck  fa-stack-1x text-[#065AD8] "
                        aria-hidden="true"
                      ></i>
                    </span>
                  </div>
        ...
        <div className="flex justify-around w-full">
          <div className="flex justify-around mt-6 w-full">
            <div className="max-w-sm rounded-md  overflow-hidden shadow-md bg-white w-full">
              <div className="">
                <div className="font-semibold border-b border-gray-200 p-2 bg-[#FAFAFB] w-full">
                  Vehicle Info
                </div>
                ...
                <div className="flex justify-between px-4">
                  <div className="flex flex-row">
                    ...
                    <p className="text-gray-700 text-sm mt-6">
                      ...
                      <p className="text-xs font-bold text-black">
                        {" "}
                        {driverDetails.country} , {driverDetails.city}
                      </p>
                    </p>
                  </div>
                  <div className="flex flex-row">
                    ...
                    <p className="text-gray-700 ml-10 text-sm mt-6">
                      ...
                      <p className="text-xs font-bold text-black">11/07/23</p>
                    </p>
                  </div>
                </div>
