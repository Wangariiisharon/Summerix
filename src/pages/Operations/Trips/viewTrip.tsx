        ...
        <div className=" w-2/5 bg-white shadow rounded-md flex flex-col">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col mt-4">
                ...
                <p className="text-xs font-nunito">
                  {tripDetails.depature_city}{" "}
                </p>
              </div>
              <div className="flex flex-col mt-11">
                <p className="text-xs font-bold">DROP OFF</p>
                <p className="text-xs font-nunito">
                  {tripDetails.arrival_city}
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex-row">
              <p className="text-xs font-nunito text-[#777E96] ml-8">
                {formattedStartTime}
              </p>
              ...
              <div
                className={`rounded-full inline-block text-sm h-8 ml-48 ${
                  tripDetails.trip_status === "Available"
                    ? "bg-[#E2E9FB] text-[#0068DD]"
                    : tripDetails.trip_status === "On Route"
                    ? "bg-[#FDAB3D] text-[#076960]"
                    : tripDetails.trip_status === "Booked"
                    ? "bg-[#579BFC] text-[#yourTextColor]"
                    : tripDetails.trip_status === "Ready for Departure"
                    ? "bg-[#A25DDC] text-[#yourTextColor]"
                    : tripDetails.trip_status === "At the border"
                    ? "bg-[#0086C0] text-[#yourTextColor]"
                    : tripDetails.trip_status === "Offloading dest"
                    ? "bg-[#7F5347] text-[#yourTextColor]"
                    : tripDetails.trip_status === "Mechanical"
                    ? "bg-[#E2445C] text-[#yourTextColor]"
                    : tripDetails.trip_status === "Done"
                    ? "bg-[#00C875] text-[#yourTextColor]"
                    : tripDetails.trip_status === "Returning the Container"
                    ? "bg-[#401694] text-[#yourTextColor]"
                    : "bg-[#EAEAEA] text-[#364250]"
                }`}
                style={{
                  width: `${tripDetails.trip_status.length * 8}px`,
                  left: "-8px",
                }}
              >
                {tripDetails.trip_status}
          ...
          <div>
            ...
            <div className="flex-row">
              <p className="text-xs font-nunito text-[#777E96] ml-8 mt-2 py-2">
                {formattedEndTime}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            <p className="font-bold text-sm ml-6 py-4">
            ...
            <div className="flex flex-row">
              <div className="flex flex-row">
                ...
                <div className="flex flex-col text-xs">
                  ...
                  <p className="text-[#071440]">
                    {tripDetails.vehicle.lisence_plate}
                  </p>
                </div>
              </div>
              <div className="flex flex-row ml-14">
                <i
                  className="fa fa-regular fa-barcode-read"
                  aria-hidden="true"
                ></i>
                <div className="flex flex-col text-xs">
          ...
          <div className="mt-10 ml-6 flex flex-row">
            ...
            <div className="flex flex-col ">
              ...
              <p className="text-xs ml-6">
                {tripDetails.requested_by.phonenumber}
              </p>
            </div>
