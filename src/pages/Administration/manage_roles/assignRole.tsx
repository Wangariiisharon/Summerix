...
export default function AssignRole(){
    ...
    const [adminDetails, setAdminDetails] = useState<RolesDetailsProps['admin'] | null>(null);
    ...
    return(   
      ...
      <TopMenu/>
          ...
          <p className='font-nunito font-regular text-sm text-[#030229]'>{adminDetails.email}</p> 
          <p className='font-nunito font-regular text-sm text-[#030229]'>{adminDetails.phonenumber}</p> 
          </div> 
          <div className='w-full ml-10 flex flex-col'>  
          <div className=' mt-5 px-10 flex flex-row mb-5'>  
          <div>
            <p className='font-nunito font-regular text-sm font-nunito font-regular'>Start Date</p>
            <p className='font-nunito font-regular text-sm text-[#030229] font-nunito font-bold'>May14 / 2:35</p> 
            </div>  
            <div className='ml-14'>
              <p className='font-nunito font-regular text-sm font-nunito font-regular'>End Date</p>
              <p className='font-nunito font-regular text-sm text-[#030229] font-nunito font-bold'>May14 / 12:40</p>
            </div>
