      ...
      {isRenameFormOpen && (
        <FormModal open={isRenameFormOpen} setOpen={setIsRenameFormOpen}>
          ...
          <div className='flex w-full h-full justify-between items-center mb-12'>
                        ...
                        <Button className='bg-red-50 h-12 w-12 flex items-center justify-center rounded-full' handleClick={handleCancel}>
            ...
            <div className='flex w-full justify-end mt-24 '>
                <Button className='text-blue text-xl mr-32' handleClick={renameDepartment}>Cancel</Button>
