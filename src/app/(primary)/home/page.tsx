      ...
      <section className="mt-5 grid-1-2 gap-5">
            ...
            <div className="">
              ...
              <div className="mt-5 grid gap-3">
                <div className="flex items-center gap-5">
                  <div className="p-2 bg-[#4FD1C5]/20 text-[#4FD1C5] rounded">
                    <TruckIcon className="h-5 w-5" />
                  </div>
                  <p className="text-gray-500">Available</p>
                </div>
                <div className="flex items-center gap-5">
                  <div className="p-2 bg-[#065AD8]/20 text-[#065AD8] rounded">
                    <TruckIcon className="h-5 w-5" />
                  </div>
                  <p className="text-gray-500">On Route</p>
                </div>
                <div className="flex items-center gap-5">
                  <div className="p-2 bg-[#FFC107]/20 text-[#FFC107] rounded">
                    <TruckIcon className="h-5 w-5" />
                  </div>
                  <p className="text-gray-500">Under Maintenance</p>
                </div>
                <div className="flex items-center gap-5">
                  <div className="p-2 bg-[#C80815]/20 text-[#C80815] rounded">
                    <TruckIcon className="h-5 w-5" />
                  </div>
                  <p className="text-gray-500">Out of service</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* <div className="p-4 bg-white rounded">
          <div className="flex items-center justify-between gap-5">
            <h3 className="text-lg">Out of service vehicles</h3>
            <Link
              href="/vehicles/out-of-service"
          ...
          <div className="mt-5">
            <div className="relative max-w-xs mx-auto w-full h-full">
              <Doughnut
                data={{
                  datasets: [
                    {
              ...
              />
              <div className="absolute top-32 left-32 z-20 text-center">
        ...
        <div className="p-4 bg-white rounded">
          <div className="flex items-center justify-between gap-5">
            <h3 className="text-lg">Trips Completed</h3>
            <Link
