...
export default function MaintenanceVehicle({ companyId, setFieldValue, maintenance }: Props) {
  const [selected, setSelected] = useState<VEHICLE_DETAILS | null>(maintenance?.vehicle || null);
