...
import { collection, query, where, onSnapshot, writeBatch, doc, Timestamp, arrayUnion, orderBy } from 'firebase/firestore';
    ...
    <div className='relative' ref={dropdownRef}>
      {isOpen &&  (
        <div className='absolute right-0 mt-2 w-80 bg-white shadow-lg rounded-md py-2 z-10'>
          ...
          <div style={{ maxHeight: '200px', overflowY: 'auto' }}> {/* Add scrollable styles here */}
          <TableBody> 
